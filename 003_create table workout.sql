...
SELECT * from country LEFT OUTER join capital on country.COUNTRY_CODE = capital.COUNTRY_CODE;
SELECT * from country RIGHT join capital on country.COUNTRY_CODE = capital.COUNTRY_CODE;

SELECT * from country LEFT OUTER join capital on country.COUNTRY_CODE = capital.COUNTRY_CODE UNION
SELECT * from country RIGHT join capital on country.COUNTRY_CODE = capital.COUNTRY_CODE;
